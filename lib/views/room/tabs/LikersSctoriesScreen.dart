...
class LikersSctoriesScreen extends StatefulWidget {

  String idStory;
  LikersSctoriesScreen({this.idStory});

  @override
  _LikersSctoriesScreenState createState() => _LikersSctoriesScreenState();
}

class _LikersSctoriesScreenState extends State<LikersSctoriesScreen> {
  String TAG = 'LikersSctoriesScreen';
  ...
  Widget buildItem(BuildContext context, DocumentSnapshot document){
    if(document.documentID==widget.idStory){
      List<dynamic> listName = document.data['likerStory'];
      List<dynamic> listPhoto = document.data['likerPhotoStory'];
